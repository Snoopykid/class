...
// import sendTokenToSMS from './phone.js'  // export default 이름바꿔서 가져오기. default를 가져온 것이기 때문에 다른 함수명(ex: qqq)을 사용해도 sendTokenToSMS를 가져옴
// import qqq, {checkPhone as zzz, getToken} from './phone.js'   // export default와 export를 함께 쓰기

// import * as ttt from './phone.js'         // export 한 번에 다 가져오기
// ttt.checkPhone                         // 대신 변경한 이름에서 객체형식으로 가져와야 함
// ttt.getToken
...
app.post("/users", function (req, res){
    // const name = req.body.name  // 가독성 떨어짐
